...
products = [
    {'id': 1, 'name': 't-shirt', 'price': '$12.99', 'created_date': '2022-01-01', 'is_on_sale': False,
     'sale_price': None},
    ...
    {'id': 5, 'name': 'trousers', 'price': '$32.50', 'created_date': '2022-01-01', 'is_on_sale': True,
     'sale_price': None},
    {'id': 6, 'name': 'jacket', 'price': '$150.00', 'created_date': '2022-01-01', 'is_on_sale': False,
     'sale_price': None},
]

filtered_products = (product for product in products if float(product['price'].replace("$", "").strip()) > 25)

print("\nProducts with prices over 25$\n\n"+"*"*25)
print()
